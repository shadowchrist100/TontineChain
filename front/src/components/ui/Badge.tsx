...
export type BadgeVariant = 'success' | 'error' | 'pending' | 'warning' | 'info' | 'default';
...
export interface BadgeProps {
  ...
  /** Text content — use either label or children */
  label?: string;
...
export const Badge = ({ variant = 'default', label, children, showDot = true, size = 'md' }: BadgeProps) => {
